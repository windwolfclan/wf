...
namespace wf
{
	...
	{
		m_vs = L"alphamap_vs.hlsl";
		m_ps = L"alphamap_ps.hlsl";
		m_vs_main = "alphamap_vs";
		m_ps_main = "alphamap_ps";
	}
	...
	bool AlphamapShader::Render( ID3D11DeviceContext* _context, int _index_count, XMMATRIX _w, XMMATRIX _v, XMMATRIX _p, ID3D11ShaderResourceView** _srvs )
	{
	...
	bool AlphamapShader::SetShaderParameters( ID3D11DeviceContext* _context, XMMATRIX _w, XMMATRIX _v, XMMATRIX _p, ID3D11ShaderResourceView** _srvs )
	{
		...
		_context->PSSetShaderResources( 0, 3, _srvs );

		return true;
	}

	void AlphamapShader::RenderShader( ID3D11DeviceContext* _context, int _index_count )
	{
	...
	bool AlphamapShader::InitializeLayout( ID3D11Device* _device, ID3D10Blob*& _blob )
	{
	...
	bool AlphamapShader::InitializeBuffers( ID3D11Device* _device )
	{
		HRESULT hr{ S_OK };
	...
	void AlphamapShader::ReleaseBuffers()
	{
