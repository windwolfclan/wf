...
namespace wf
{
	DualTextureShader::DualTextureShader()
	{
		m_vs = L"dual_vs.hlsl";
		m_ps = L"dual_ps.hlsl";
		m_vs_main = "dual_vs";
	...
	DualTextureShader::DualTextureShader( const DualTextureShader& )
	{
	}
	...
	void DualTextureShader::RenderShader( ID3D11DeviceContext* _context, int _index_count )
	{
	...
	bool DualTextureShader::InitializeLayout( ID3D11Device* _device, ID3D10Blob*& _blob )
	{
	...
	bool DualTextureShader::InitializeBuffers( ID3D11Device* _device )
	{
	...
	void DualTextureShader::ReleaseBuffers()
	{
